-- Run this in your Supabase SQL Editor to add the Day Attendance feature
-- This allows users to join/leave specific days of the trip

-- Create day_attendance table
